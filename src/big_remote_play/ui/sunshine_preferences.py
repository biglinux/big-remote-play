...
class SunshinePreferencesPage(Adw.PreferencesPage):
    def __init__(self, **kwargs):
        ...
        self.set_title("Sunshine")  # product name — never translated
    ...
    def get_network_options(self):
        return [
            ...
            ("address_family", _("Address Family"), "combo", "ipv4", [("ipv4", "IPv4"), ("both", "IPv4 + IPv6")], _("Set the address family used by Sunshine")),
            ...
            (
                ...
                "47989",
                None,
                _("Set the family of ports used by Sunshine.\nTCP: 47984, 47989, 48010\nUDP: 47998 - 48012\nThe Web UI port stays local by default."),
            ),
            (
    ...
    def get_input_options(self):
        return [
            ...
            (
                "gamepad",
                _("Emulated Gamepad Type"),
                "combo",
                "auto",
                [("auto", _("Automatic")), ("x360", "Xbox 360"), ("ds4", "DualShock 4"), ("ds5", "DualSense (Linux)"), ("switch", "Nintendo Switch"), ("xone", "Xbox One")],
    ...
    def get_av_options(self):
        ...
        # NOTE: validating the configured output_name against detected monitors is
        # not yet wired up; the option list below only offers detected monitors.
        ...
        return [
            ...
            (
                ...
                _("Display Name"),
                "combo",
                monitors[0][0] if monitors else "auto",
                monitors,
                _("Select the display monitor to capture. Corresponds to the output connector name (e.g., DP-1, HDMI-A-1)."),
            ),
            (
                "max_bitrate",
                _("Maximum Bitrate"),
                ...
                "0",
                None,
                _("The maximum bitrate (in Kbps) that Sunshine will encode the stream at. If set to 0, it will always use the bitrate requested by Moonlight."),
            ),
            (
                "min_fps",
                ...
                "0",
                None,
                _("The lowest effective FPS a stream can reach. A value of 0 is treated as roughly half of the stream's FPS. A setting of 20 is recommended if you stream 24 or 30fps content."),
            ),
        ]
    ...
    def get_advanced_options(self):
        return [
            (
                ...
                "20",
                None,
                _("Percentage of error correcting packets per data packet in each video frame. Higher values can correct for more network packet loss, but at the cost of increasing bandwidth usage."),
            ),
            (
                "qp",
            ...
            (
                "encoder",
                _("Force a Specific Encoder"),
                "combo",
                "auto",
                [("auto", _("Autodetect")), ("nvenc", "NVIDIA NVENC"), ("vaapi", "VA-API"), ("software", "Software"), ("quicksync", "Intel QuickSync"), ("amdvce", "AMD AMF")],
                _(
                    "Force a specific encoder, otherwise Sunshine will select the best available option. Note: If you specify a hardware encoder on Windows, it must match the GPU where the display is connected."
                ),
            ),
        ]
    ...
    def get_nvenc_options(self):
        return [
            (
                ...
                "combo",
                "1",
                [("1", "P1 (Fastest)"), ("2", "P2"), ("3", "P3"), ("4", "P4 (Default)"), ("5", "P5"), ("6", "P6"), ("7", "P7 (Best Quality)")],
                _(
                    "Higher numbers improve compression (quality at given bitrate) at the cost of increased encoding latency. Recommended to change only when limited by network or decoder, otherwise similar effect can be accomplished by increasing bitrate."
                ),
            ),
            (
                "nvenc_twopass",
                ...
                _(
                    "Adds preliminary encoding pass. This allows to detect more motion vectors, better distribute bitrate across the frame and more strictly adhere to bitrate limits. Disabling it is not recommended since this can lead to occasional bitrate overshoot and subsequent packet loss."
                ),
            ),
