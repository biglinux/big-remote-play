...
class GuestView(Gtk.Box):
    ...
    def create_discover_page(self):
        ...
        helper = create_helper_card(
            ...
            [
                ('network-wireless-symbolic', _('Check your local network'),
                 _('Make sure the host and this device are on the same Wi-Fi or wired network.')),
                ('network-wired-symbolic', _('Use the manual connection'),
                 _('Enter the host IP address or hostname and port to connect directly.')),
                ('dialog-password-symbolic', _('Use the PIN code'),
                 _('Ask the host for the PIN code and connect quickly and securely.')),
            ],
        )
